...
@Options({})
export default class ProductsDevelopment extends Vue {
    ...
    question() {
        this.$store.state.selectedMail.subject = (this.$i18n.locale == "cz") ? cz.labels.productsDevelopment : en.labels.productsDevelopment;
