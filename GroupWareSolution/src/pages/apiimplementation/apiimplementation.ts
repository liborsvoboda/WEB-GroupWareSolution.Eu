...
@Options({})
export default class ApiImplementation extends Vue {
    ...
    question() {
        this.$store.state.selectedMail.subject = (this.$i18n.locale == "cz") ? cz.labels.ApiImplementation : en.labels.ApiImplementation;
