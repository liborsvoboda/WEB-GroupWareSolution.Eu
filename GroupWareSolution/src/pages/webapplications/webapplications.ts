...
@Options({})
export default class WebApplications extends Vue {
    ...
    question() {
        this.$store.state.selectedMail.subject = (this.$i18n.locale == "cz") ? cz.labels.webApplications : en.labels.webApplications;
