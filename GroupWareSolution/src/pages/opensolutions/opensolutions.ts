...
@Options({})
export default class OpenSolutions extends Vue {
    ...
    question() {
        this.$store.state.selectedMail.subject = (this.$i18n.locale == "cz") ? cz.labels.openSolutions : en.labels.openSolutions;
