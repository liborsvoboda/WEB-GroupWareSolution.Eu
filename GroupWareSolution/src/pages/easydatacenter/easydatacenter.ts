...
@Options({})
export default class EasyDataCenter extends Vue {
    ...
    question() {
        this.$store.state.selectedMail.subject = (this.$i18n.locale == "cz") ? cz.labels.easydatacenter : en.labels.easydatacenter;
