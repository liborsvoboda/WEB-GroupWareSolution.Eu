...
@Options({})
export default class MultiPlatform extends Vue {
    ...
    question() {
        this.$store.state.selectedMail.subject = (this.$i18n.locale == "cz") ? cz.labels.multiplatform : en.labels.multiplatform;
