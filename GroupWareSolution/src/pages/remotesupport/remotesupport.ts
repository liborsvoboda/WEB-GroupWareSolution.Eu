...
@Options({})
export default class RemoteSupport extends Vue {
    ...
    question() {
        this.$store.state.selectedMail.subject = (this.$i18n.locale == "cz") ? cz.labels.remoteSupport : en.labels.remoteSupport;
